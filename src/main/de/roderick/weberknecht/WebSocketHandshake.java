...
{	
	...
	public byte[] getHandshake_hybi10()
	{
		/** gen key */
		...
		String key = Integer.toString(product1)+"==";
		...
		try {
			...
			md.update(acceptKey.getBytes());
			byte akb[] = new byte[20]; 
			Arrays.copyOfRange(md.digest(), 0, 19);
			String akbString = String.valueOf(akb);
			md = MessageDigest.getInstance("MD5");
			md.update(akbString.getBytes());
			expectedServerResponse = md.digest();
			acceptKey = String.valueOf(md.digest());
